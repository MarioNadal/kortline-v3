...
**Estado al cerrar esta sesión:** todo lo pedido está implementado, testeado (245/245 en 22 archivos) y desplegado tanto a producción como a `/test/`. No hay ningún bug conocido pendiente ni tarea a medias.
